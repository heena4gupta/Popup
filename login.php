    ...
    if($count == 1){
        ...
        if (isset($_COOKIE["product_list"])) {
            ...
            for ($i=0; $i < count($product_list); $i++) {
                ...
                $verify_cart = "SELECT cart_id FROM cart WHERE user_id = $_SESSION[user_id] AND p_id = ".$product_list[$i];
                ...
                if(mysqli_num_rows($result) < 1){
                    ...
                    $update_cart = "UPDATE cart SET user_id = '$_SESSION[user_id]' WHERE ip_add = '$ip_add' AND user_id = -1";
                    ...
                    mysqli_query($conn,$delete_existing_product);
                }
            }
